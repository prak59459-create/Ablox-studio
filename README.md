...
- [Ablox `docs/scripting.ja.md`](https://github.com/prak59459-create/Ablox/blob/main/docs/scripting.ja.md) — `.absc` でゲームを作る: the **Script** tab, GUI, cameras, NPCs, building the map
- [Ablox `docs/scripting.md`](https://github.com/prak59459-create/Ablox/blob/main/docs/scripting.md) — AbloxScript reference and design
